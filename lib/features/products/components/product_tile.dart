          ...
          Widget Read() => Column(
                ...
                children: [
                  IconButton.filledTonal(
                    ...
                    onPressed: () {
                      setProduct(product.copyWith(editing: true));
                    },
          ...
          Widget Edit() => Column(
                ...
                children: [
                  IconButton.filledTonal(
                    tooltip: 'edit product',
                    onPressed: () {
                      setProduct(product.copyWith(editing: false));
                    },
                  ...
                  DropdownButtonFormField(
                    ...
                    items: Brand.values
                        ...
                        .toList(),
                    onChanged: (_) {
                      setProduct(product.copyWith(brand: _!));
                    },
                  ).pad(),
                  DropdownButtonFormField(
                  ...
                  TextFormField(
                    ...
                    onChanged: (value) {
                      setProduct(product.copyWith(model: value));
                    },
                  ...
                  TextFormField(
                    ...
                    onChanged: (nullablePrice) {
                      ...
                      setProduct(product.copyWith(price: price));
                    },
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        setProduct(product.copyWith(image: str));
                      },
                      child: product.image == ''
                          ? 'Pick Image'.text()
                          : Image.memory(
